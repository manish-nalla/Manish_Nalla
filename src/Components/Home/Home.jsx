        ...
        <section className='intro' id='home'>
            <div className="introcontent">
                ...
                <ul className='social-links'>
                    <li className='social-linkitems'><a href="https://www.linkedin.com/in/manish-nalla/" target='_blank' rel='noopener noreferrer'><i className="fa-brands fa-linkedin"></i></a></li>
                    <li className='social-linkitems'><a href="https://github.com/manish-nalla" target='_blank' rel='noopener noreferrer'><i className="fa-brands fa-github"></i></a></li>
