...
const Projects = () =>{
    ...
    const projects_array =[
        ...
        {id:2, name:"Weather App", technologies: 'React, Tailwind, API Integration', icon: <img src={weatherImage} alt='Weather_Application'/>, github: 'https://weather-app-by-manish.netlify.app/'},
    ]
